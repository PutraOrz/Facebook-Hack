...
echo $i" |"$cy"          CRACKED TERMUX INDONESIA"$i"         |"
echo $i" |"$me"───────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR    :"$ku" MR.0RZ  [VOXcyber]"$i"            |"
echo $i" |"$pu" FACEBOOK  :"$ku" Rela Saputra"$i"                  |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.4KJM] [MR.D4RKworld]"$i"     |"
echo $i" |"$cy"            ~ [MRS.V3NOM] [MR.Trickster]"$i"   |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 082243325745"$i"           |"
echo $i" |"$pu" Contack Gmail :"$ku" revoxSH3223@gmail.com"$i"     |"
echo $i"["$bi"•"$i"]"$me"─────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB V3NOM      "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB 4KMJ       "$i"|"$i"    |"$cy" N"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE D4RKworld      "$i"|"$i"    |"$cy" K"$i" |"
...
echo $i"────────────────────────────────"$i"    |"$cy" R"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU COK   "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" N"$i" |"
echo $i"─────────────────────────────────────────"
echo
echo $me"┌==="$bi"["$i"VOXcyber"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
